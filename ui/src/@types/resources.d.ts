  ...
  "translation": {
    ...
    "sidebar": {
      ...
      "sharing": {
        ...
        "share_label_placeholder": "Family, client, website...",
        "share_label_update_error": "Could not update share label",
    ...
    "terms_of_use": {
      "agreement_intro": "By accessing, using, or interacting with this product/service you explicitly agree to the <licenseLink>Ethical Use License</licenseLink>.",
      "badge": {
      ...
      "conditions": {
        ...
        "forbidden_citizens": "Citizens/residents of Russia, Belarus, Iran, and/or North Korea are strictly forbidden from using this product/service",
        ...
        "terrorist_state": "You agree that <doc>Russia is a terrorist state</doc>."
      },
      "declined": {
        "close_tab": "Please close this tab.",
        "message": "You have declined the <licenseLink>Ethical Use License</licenseLink>. You must not use this service.",
        "title": "Access Denied"
      },
      "modal": {
        "action": {
    ...
    "update_available_page": {
      "action": "Refresh page",
      "content": "This tab is using an older UI build and some page files are no longer available on the server. Please refresh the page to continue.",
      "header": "Page refresh required"
    }
  }
}
