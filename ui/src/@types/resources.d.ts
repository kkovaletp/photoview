...
export default interface Resources {
  "translation": {
    ...
    "service_worker": {
      "update_available": {
        "action": "Update",
        "content": "A new version of Photoview is available on the server. Click \"Update\" to reload all Photoview tabs and apply the update. Or close this message to continue using the current version and reload manually later.",
        "header": "Photoview version update available"
      }
    },
    "settings": {
      "concurrent_workers": {
