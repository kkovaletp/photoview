...
export default interface Resources {
  "translation": {
    "album": {
      "breadcrumb_aria_label": "Album breadcrumb"
    },
    "album_filter": {
    ...
    "general": {
      ...
      "notFound": "Face group not found"
    },
    "header": {
      "logo_alt": "Photoview logo",
      "search": {
    ...
    "people_page": {
      ...
      "modal": {
        ...
        "merge_face_groups": {
          "destination_description": "Select the face group that other groups should be merged into.",
          "destination_table": {
    ...
    "settings": {
      "concurrent_workers": {
        ...
        "error": "Failed to load concurrent workers setting",
        "title": "Scanner concurrent workers"
      },
      "logout": "Log out",
      "periodic_scanner": {
        "checkbox_label": "Enable periodic scanner",
        "error": "Failed to load periodic scanner settings",
        "field": {
    ...
    "sidebar": {
      ...
      "download": {
        "error": "Failed to load download options",
        "filesize": {
          "byte_one": "{{count}} Byte",
      ...
      "error": "Error loading media details: {{message}}",
      "location": {
        "title": "Location"
      },
      "media": {
    ...
    "terms_of_use": {
      "badge": {
        "agreement_intro": "By accessing or sharing this service, you agree to the",
        "button_aria_label": "View Terms of Use",
        "button_title": "Terms of Use (Mandatory)",
        "conditions": {
          "condemn_aggression": "You condemn Russia's military aggression against Ukraine",
          "forbidden_citizens": "Forbidden for citizens/residents of Russia, Belarus, Iran, or North Korea",
          "recognize_sovereignty": "You recognize Ukraine as a sovereign, independent state",
          "reject_propaganda": "You reject Russian state propaganda",
          "support_territorial_integrity": "You support Ukraine's full territorial integrity"
        },
        "dialog_aria_label": "Terms of Use",
        "key_conditions_suffix": "Key conditions:"
      },
      "ethical_use_license_link": "Ethical Use License",
      "modal": {
        "action": {
          "accept": "I Agree",
        ...
        "conditions": {
          "condemn_aggression": "You unequivocally condemn Russia's military aggression against Ukraine",
          "forbidden_citizens": "Citizens/residents of Russia, Belarus, Iran, or North Korea are strictly forbidden from using this product/service",
          "recognize_invasion": "You recognize that Russia unlawfully invaded a sovereign state",
          "reject_propaganda": "You reject narratives perpetuated by Russian state propaganda",
          "support_territorial_integrity": "You fully support Ukraine's territorial integrity",
          "terrorist_state_p1": "You agree that",
          "terrorist_state_p2": "Russia is a terrorist state"
        },
        "description_intro": "By accessing, using, or interacting with this service you explicitly agree to the",
